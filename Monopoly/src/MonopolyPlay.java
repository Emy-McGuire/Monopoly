...
public class MonopolyPlay {
	...
	static void locationPics() {
		...
		case 16: {
			...
			JOptionPane.showMessageDialog(frame, "You have landed on THE BOG", null, JOptionPane.QUESTION_MESSAGE,
					cottage);
			MonopolyBank.landOnProperty();
			break;
		}
		...
		case 21: {
			ImageIcon cottage = new ImageIcon(("jungle.jpg"));
		...
		case 22: {
			ImageIcon cottage = new ImageIcon(("CommunityChest4.jpg"));
			JOptionPane.showMessageDialog(frame, "You have landed on a COMMUNITY CHEST TILE", null,
					JOptionPane.QUESTION_MESSAGE, cottage);
			break;
		}
		case 23: {
			ImageIcon cottage = new ImageIcon(("pacha.jpg"));
		...
		case 24: {
			ImageIcon cottage = new ImageIcon(("kuzco.jpg"));
		...
		case 25: {
			ImageIcon cottage = new ImageIcon(("AristocatsRailroad.jpg"));
		...
		case 26: {
			ImageIcon cottage = new ImageIcon(("belleVillage.jpg"));
		...
		case 27: {
			ImageIcon cottage = new ImageIcon(("woods.jpg"));
		...
		case 29: {
			ImageIcon cottage = new ImageIcon(("beast.jpg"));
		...
		case 31: {
			ImageIcon cottage = new ImageIcon(("lair.jpg"));
		...
		case 32: {
			ImageIcon cottage = new ImageIcon(("ship.jpg"));
		...
		case 33: {
			ImageIcon cottage = new ImageIcon(("CommunityChest5.jpg"));
			JOptionPane.showMessageDialog(frame, "You have landed on a COMMUNITY CHEST TILE", null,
					JOptionPane.QUESTION_MESSAGE, cottage);
			break;
		}
		case 34: {
			ImageIcon cottage = new ImageIcon(("tritonKingom.jpg"));
		...
		case 36: {
			ImageIcon cottage = new ImageIcon(("CommunityChest6.jpg"));
			JOptionPane.showMessageDialog(frame, "You have landed on a COMMUNITY CHEST TILE", null,
					JOptionPane.QUESTION_MESSAGE, cottage);
			break;
		}
		...
		case 38: {
			ImageIcon cottage = new ImageIcon(("TaxPic2.jpg"));
			JOptionPane.showMessageDialog(frame, "You have landed on AURORA'S COTTAGE", null,
					JOptionPane.QUESTION_MESSAGE, cottage);
			break;
		}
